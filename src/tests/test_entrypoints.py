...
def main(argv: list[str] | None = None) -> int:
    ...
    run_claim(failures, claim_step_list_matches, failures)
    run_claim(failures, claim_ok_codes_declared, failures)
    run_claim(failures, claim_subscription_refusal_is_fatal, failures)
    run_claim(failures, claim_operator_tools_spare_artifacts, failures)
    run_claim(failures, claim_the_narrative_writers_spare_artifacts_too, failures)
    run_claim(failures, claim_calendar, failures)
    run_claim(failures, claim_calendar_refresh_keeps_the_cache, failures)
    run_claim(failures, claim_universe, failures)
    run_claim(failures, claim_universe_force, failures)
    run_claim(failures, claim_gap_stats, failures)
    run_claim(failures, claim_discover, failures)
    run_claim(failures, claim_baseline, failures)
    run_claim(failures, claim_collector, failures)
    run_claim(failures, claim_scan, failures)
    run_claim(failures, claim_analyst, failures)
    run_claim(failures, claim_render, failures)
    ...
    run_claim(failures, claim_outcomes_writes_the_excursions, failures)
    run_claim(failures, claim_pool_recall, failures)
    run_claim(failures, claim_monitor, failures)
    run_claim(failures, claim_midday_runs_and_renders, failures)
    print("")
    print("the recording itself:")
    run_claim(failures, claim_failure_is_recorded, failures)
    run_claim(failures, claim_broad_catches_record, failures)
    run_claim(failures, claim_watchdog_reads_steps, failures)
    run_claim(failures, claim_report_line, failures)
